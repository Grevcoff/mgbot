...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8707681706:AAHQsbpy3kAMyBte3WbSuMQ2YlFoUrYC9Yk")  # Вставьте сюда ваш токен от @BotFather
ADMIN_ID = int(os.getenv("ADMIN_ID", "568770099"))  # Замените на ваш Telegram ID
